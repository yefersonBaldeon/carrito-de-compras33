...
$coneccion = mysqli_connect("localhost", "root", "", "carrito");
...
<body>
    ...
    <div class="container blanco py-5 mt-5" style="width:400px;">
        ...
        <h1 class="text-center text-danger mb-5">MODICAR PRODUCTO</h1>
        ...
        <form action="modificar.php" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" value="<?php echo $arreglo[1] ?>" name="nombre" required>
            </div>

            <div class="mb-3">

                <label for="usuario" class="form-label">Precio:</label>
                <input type="number" class="form-control" value="<?php echo $arreglo[2] ?>" name="precio" required>
            </div>
            ...
            <input type="hidden" value="<?php echo $arreglo[0]?>"  name="codigo" >
